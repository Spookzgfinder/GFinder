...
def make_embed(group_info, date):
    return dict(
        ...
        fields=[
            dict(name="**__Group Details :__**", value=f"**・ID:** {group_info['id']}\n**・Name:** {group_info['name']}\n**・Members:** {group_info['memberCount']}\n\n"),
        ],
        author=dict(
          name="SYSTEMIC S",
          icon_url="https://images-ext-2.discordapp.net/external/dSLJow8gUz1yaN77GAhjvpQELQPEGL_Gx9gzRu1Yudw/%3Fsize%3D4096/https/cdn.discordapp.com/icons/1006624499053101066/a_5881bc5b7fb1bb60cffb5c8e2ba8439a.gif"
        ),
       color=random.randint(000000, 000000),
      
        footer=dict(
            text="© SYS Finder | Boost for better finder",
            icon_url="https://images-ext-2.discordapp.net/external/dSLJow8gUz1yaN77GAhjvpQELQPEGL_Gx9gzRu1Yudw/%3Fsize%3D4096/https/cdn.discordapp.com/icons/1006624499053101066/a_5881bc5b7fb1bb60cffb5c8e2ba8439a.gif"
        ),
    )
